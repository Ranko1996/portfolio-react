        ...
        <div className='wrapper'>
            <header>
                ...
                <nav className={!isOpen ? "" : "open-nav"}>
                  <svg onClick={handleClick} className="close" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg onClick={handleClick} className="menu" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
